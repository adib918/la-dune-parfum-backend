...
Route::get('verified-email/{id}/{hash}', [VerifyEmailController::class, 'verify'])->middleware(['auth:sanctum', 'signed'])->domain("https://www.laduneparfum.com")->name('verification.verify');
